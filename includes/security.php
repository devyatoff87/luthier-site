...
// ========== RATE LIMITING ==========
function checkRateLimit($key, $maxAttempts = null, $timeout = null) {
    $maxAttempts = $maxAttempts ?? RATE_LIMIT_ATTEMPTS;
    $timeout = $timeout ?? RATE_LIMIT_TIMEOUT;
...
// ========== UPLOAD SICHERHEIT ==========
function validateImageUpload($file, $maxSize = null) {
...
function logSecurityEvent($event, $details = '') {
    ...
    $entry = date('Y-m-d H:i:s') . ' | ' . ($_SERVER['REMOTE_ADDR'] ?? 'CLI') . ' | ' . $event . ' | ' . $details . PHP_EOL;
